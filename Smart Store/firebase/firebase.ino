...
RFID rfid(15, 16);       //D10:pin of tag reader SDA. D9:pin of tag reader RST 
...
//String device_id="RDNA(1)";
//boolean checkIn = true;
if (json.add(temp=="72101118111")){
  String device_id="RDNA";
}
if (json.add(temp=="235783911"){
  String device_id="RDNA-1";
}
